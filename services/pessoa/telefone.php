...
class Telefone {
    ...
    public function upsert($id = null, $telefone) {
...
$telefone->upsert(null, null, 'SP', 'São Paulo', 'Centro');

$telefone->upsert(1, '87654321', 'RJ', 'Rio de Janeiro', 'Zona Sul');
